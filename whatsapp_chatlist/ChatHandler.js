...
const chat_names = ["Sreeram Panigrahi", "Onkar Mathekar", "Sonali Adhikary", "Jadav Pal", "Shreya Harris", "Steve Jobs", "Bill Gates"];
const chat_names_length = chat_names.length;
const chat_msg = ["Why were you late to the party...",
